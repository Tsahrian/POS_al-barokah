            ...
            <div class="box">
                <form action="{{ route('user.update_profil') }}" method="post" class="form-profil" data-toggle="validator"
                    ...
                    <div class="box-body">
                        ...
                        <div class=" form-group row">
                            <label for="old_password" class=" col-lg-2 col-lg-offset-1 control-label">Password</label>
                            <div class=" col-lg-6">
                        ...
                        <div class=" form-group row">
                            <label for="password_confirmation" class=" col-lg-2 col-md-offset-1 control-label">Konfirmasi
                                Password</label>
                            <div class=" col-md-6">
